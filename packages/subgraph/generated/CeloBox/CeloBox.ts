...
export class NFTMint extends ethereum.Event {
  get params(): NFTMint__Params {
    return new NFTMint__Params(this);
  }
}

export class NFTMint__Params {
  _event: NFTMint;

  constructor(event: NFTMint) {
    this._event = event;
  }
...
export class CeloBox extends ethereum.SmartContract {
  static bind(address: Address): CeloBox {
    return new CeloBox("CeloBox", address);
  }
